...
%     load('ins\oab.mat')
    ...
    geo.name.Name_glacier = [{'Vatnajökull'},'Hofsjökull','Langjökull','Mýrdalsjökukll','Drangajökull','Eyjafjallajökull',...
        'Snæfell','Þrándarjökull','Hofsjökull Eystri','Eiríksjökul','Tungnafellsjökull','Torfajökull']'    ;
    
%%
names = [{'N1'},'N2','N3','Eiríksjökull','N4','N5','N6','N7','Þrándarjökull','Hofsjökull','N8','Drangajökull','Snæfell','Langjökull','N9','Vatnajökull','Hofsjökull Eystri','N10','Eyjafjallajökull','N11','N12','N13','N14','Tungnafellsjökull','N15','N16','Torfajökull','Mýrdalsjökull','N17','N18','N19','N20','N21','N22']';
for i = 1:34;
